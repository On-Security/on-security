...
public class UserGenderTypeMapper implements TypeMapper<UserGender, String> {
    @Override
    public String toColumn(UserGender originalValue, String columnName) {
        return originalValue != null ? originalValue.getValue() : null;
    }

    @Override
    public UserGender fromColumn(ResultSet rs, String columnName) throws SQLException {
        String columnValue = rs.getString(columnName);
        return !ObjectUtils.isEmpty(columnValue) ? new UserGender(columnValue) : null;
    }
}
