...
public interface SecurityRegionIdentityProviderRepository extends OnSecurityBaseJdbcRepository<SecurityRegionIdentityProvider, String> {
     ...
     *
     * @param registrationId {@link SecurityRegionIdentityProvider#getRegistrationId()}
     * @return {@link SecurityRegionIdentityProvider}
     */
    SecurityRegionIdentityProvider findByRegistrationId(String registrationId);
}
