 ...
 * @since 0.0.1
 */
public class SecurityUserAuthorizeApplicationJdbcRepository extends OnSecurityBaseJdbcRepositorySupport<SecurityUserAuthorizeApplication, String>
        implements SecurityUserAuthorizeApplicationRepository {
    public SecurityUserAuthorizeApplicationJdbcRepository(JdbcOperations jdbcOperations) {
        super(OnSecurityTables.SecurityUserAuthorizeApplications, jdbcOperations);
    }
