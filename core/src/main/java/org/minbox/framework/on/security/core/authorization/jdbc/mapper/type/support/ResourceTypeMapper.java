 ...
 * @since 0.0.8
 */
public class ResourceTypeMapper implements TypeMapper<ResourceType, String> {
    @Override
    public String toColumn(ResourceType originalValue, String columnName) {
        return originalValue != null ? originalValue.getValue() : null;
    }

    @Override
    public ResourceType fromColumn(ResultSet rs, String columnName) throws SQLException {
        String columnValue = rs.getString(columnName);
        return !ObjectUtils.isEmpty(columnValue) ? new ResourceType(columnValue) : null;
    }
}
