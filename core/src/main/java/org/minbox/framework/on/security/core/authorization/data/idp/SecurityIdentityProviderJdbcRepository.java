 ...
 * @since 0.0.2
 */
public class SecurityIdentityProviderJdbcRepository extends OnSecurityBaseJdbcRepositorySupport<SecurityIdentityProvider, String>
        implements SecurityIdentityProviderRepository {
    public SecurityIdentityProviderJdbcRepository(JdbcOperations jdbcOperations) {
        super(OnSecurityTables.SecurityIdentityProvider, jdbcOperations);
    }
}
