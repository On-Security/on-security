...
/**
 * 转换管理令牌（Manage Token）授权认证请求实体 {@link OnSecurityManageTokenAuthorizationRequestToken}
 *
 * @author 恒宇少年
 * @since 0.1.0
 */
public class OnSecurityManageTokenAuthorizationConvert implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        OnSecurityManageTokenAuthorizationRequestToken authorizationRequestToken = new OnSecurityManageTokenAuthorizationRequestToken(manageToken);
