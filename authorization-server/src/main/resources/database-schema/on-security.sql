...
INSERT INTO `gloabl_data_authorization_grant`
VALUES ('3950e707-6b0b-11ed-b779-0242ac110003', '授权码模式', 'authorization_code', NULL),
       ('461ba332-6b0b-11ed-b779-0242ac110003', '刷新令牌模式', 'refresh_token', NULL),
       ('4b48c30a-6b0b-11ed-b779-0242ac110003', '密码模式', 'password', NULL),
       ('67e87832-6b0b-11ed-b779-0242ac110003', '客户端模式', 'client_credentials', NULL),
       ('6ee85c04-6b0b-11ed-b779-0242ac110003', '简化模式', 'implicit', NULL);
...
INSERT INTO `global_data_authentication_method`
VALUES ('5ad881f4-6b11-11ed-b779-0242ac110003', 'client_secret_post', NULL),
       ('606a14b6-6b11-11ed-b779-0242ac110003', 'client_secret_basic', NULL),
       ('6354cb0f-6b11-11ed-b779-0242ac110003', 'client_secret_jwt', NULL),
       ('6655df1f-6b11-11ed-b779-0242ac110003', 'private_key_jwt', NULL),
       ('69610d47-6b11-11ed-b779-0242ac110003', 'none', NULL);
...
INSERT INTO `global_data_client_protocol`
VALUES ('39466096-80d4-11ed-b8e3-0242ac110003', 'OAuth2.0', _binary '', 'OAuth 2.0 是标准的授权协议'),
       ('939b64bc-6b06-11ed-b779-0242ac110003', 'OpenID Connect1.0', _binary '',
        'OpenID Connect1.0 是 OAuth 2.0 协议之上的简单身份协议'),
       ('d2381524-6b06-11ed-b779-0242ac110003', 'SAML2.0', _binary '',
        '安全断言标记语言（SAML）是一种用于在各方之间交换身份验证和授权数据的开放标准');
...
INSERT INTO `global_data_signature_algorithm`
VALUES ('216d76f6-6ba1-11ed-b5c2-0242ac110002', 'HS256', NULL),
       ('231013a5-6ba1-11ed-b5c2-0242ac110002', 'RS256', NULL),
       ('3e9f13e1-6ba1-11ed-b5c2-0242ac110002', 'ES256', NULL),
       ('b6b83793-6ba1-11ed-b5c2-0242ac110002', 'HS384', NULL),
       ('bafbc213-6ba1-11ed-b5c2-0242ac110002', 'HS512', NULL),
       ('c5d35417-6ba1-11ed-b5c2-0242ac110002', 'RS384', NULL),
       ('d2a6d2db-6ba1-11ed-b5c2-0242ac110002', 'RS512', NULL),
       ('d8435c32-6ba1-11ed-b5c2-0242ac110002', 'ES256K', NULL),
       ('da7e7841-6ba1-11ed-b5c2-0242ac110002', 'ES384', NULL),
       ('dcadf341-6ba1-11ed-b5c2-0242ac110002', 'ES512', NULL),
       ('df32f309-6ba1-11ed-b5c2-0242ac110002', 'PS256', NULL),
       ('e14f421a-6ba1-11ed-b5c2-0242ac110002', 'PS384', NULL),
       ('e3b56f64-6ba1-11ed-b5c2-0242ac110002', 'PS512', NULL);
...
DROP TABLE IF EXISTS `security_application_authentication`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `security_application_redirect_uris`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `security_application_scope`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
(
    `id`                 varchar(36)  NOT NULL COMMENT 'ID',
    `application_id`     varchar(36)  NOT NULL COMMENT '应用ID',
    `application_secret` varchar(100) NOT NULL COMMENT '应用密钥',
...
--
-- Table structure for table `security_console_manager`
--

DROP TABLE IF EXISTS `security_console_manager`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `security_console_manager`
(
    ...
    `delete_time`     datetime             DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='控制台管理员';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `security_console_manager`
--

/*!40000 ALTER TABLE `security_console_manager` DISABLE KEYS */;
/*!40000 ALTER TABLE `security_console_manager` ENABLE KEYS */;

--
-- Table structure for table `security_console_manager_authorize_menus`
--

DROP TABLE IF EXISTS `security_console_manager_authorize_menus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `security_console_manager_authorize_menus`
(
    `id`             varchar(36) NOT NULL COMMENT 'ID',
    `region_id`      varchar(36) NOT NULL COMMENT '安全域ID',
    `manager_id`     varchar(36) DEFAULT NULL COMMENT '管理员ID',
    `menu_id`        varchar(36) DEFAULT NULL COMMENT '菜单ID',
    `authorize_time` datetime    DEFAULT NULL COMMENT '授权时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='控制台管理员授权菜单关系';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `security_console_manager_authorize_menus`
--

/*!40000 ALTER TABLE `security_console_manager_authorize_menus` DISABLE KEYS */;
/*!40000 ALTER TABLE `security_console_manager_authorize_menus` ENABLE KEYS */;

--
-- Table structure for table `security_console_manager_session`
--

DROP TABLE IF EXISTS `security_console_manager_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `security_console_manager_session`
(
    `id`                      varchar(36) NOT NULL COMMENT 'ID',
    `region_id`               varchar(36) NOT NULL COMMENT '安全域ID',
    `authenticate_type`       varchar(30) NOT NULL COMMENT '会话认证类型，username_password：用户名密码方式；id_secret：安全域ID与密钥方式认证',
    `manager_id`              varchar(36) DEFAULT NULL COMMENT '管理员ID，username_password认证方式该列存在值',
    `region_secret_id`        varchar(36) DEFAULT NULL COMMENT '安全域密钥ID，id_secret认证方式该列存在值',
    `manage_token_value`      text        DEFAULT NULL COMMENT 'ManageToken值',
    `manage_token_issued_at`  datetime    DEFAULT NULL COMMENT 'ManageToken发布时间',
    `manage_token_expires_at` datetime    DEFAULT NULL COMMENT 'ManageToken过期时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='控制台管理账号会话';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `security_console_manager_session`
--

/*!40000 ALTER TABLE `security_console_manager_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `security_console_manager_session` ENABLE KEYS */;

--
-- Table structure for table `security_console_menu`
--

DROP TABLE IF EXISTS `security_console_menu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `security_console_menu`
(
    `id`            varchar(36) NOT NULL COMMENT '菜单ID',
    `name`          varchar(30) NOT NULL COMMENT '菜单名称',
    `business_code` varchar(30) NOT NULL COMMENT '菜单业务码',
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='控制台菜单';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `security_console_menu`
--

/*!40000 ALTER TABLE `security_console_menu` DISABLE KEYS */;
INSERT INTO `security_console_menu`
VALUES ('e7ceb966-a2db-11ed-8423-0242ac110002', '我的应用', 'application_manage', NULL, _binary '', _binary '\0',
        '2023-02-02 09:28:08', NULL, NULL);
/*!40000 ALTER TABLE `security_console_menu` ENABLE KEYS */;
...
DROP TABLE IF EXISTS `security_group_authorize_applications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
INSERT INTO `security_identity_provider`
VALUES ('3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, '码云', 'OAuth2.0',
        'Gitee.com（码云） 是OSCHINA.NET 推出的代码托管平台，支持Git 和SVN，提供免费的私有仓库托管', NULL,
        'https://gitee.com/oauth/authorize', 'https://gitee.com/oauth/token', 'https://gitee.com/api/v5/user', 'header',
        'login', NULL, NULL, 'client_secret_post', 'authorization_code', _binary '', '2022-12-20 17:25:30'),
       ('8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'GitHub', 'OAuth2.0',
        'GitHub是一个在线软件源代码托管服务平台，使用Git作为版本控制软件', NULL,
        'https://github.com/login/oauth/authorize', 'https://github.com/login/oauth/access_token',
        'https://api.github.com/user', 'header', 'login', NULL, NULL, 'client_secret_basic', 'authorization_code',
        _binary '', '2022-12-20 18:38:54'),
       ('8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'Facebook', 'OAuth2.0',
        'Facebook（简称FB），民间常译为脸书、脸谱、面簿，是一个社交网路服务网站', NULL,
        'https://www.facebook.com/v2.8/dialog/oauth', 'https://graph.facebook.com/v2.8/oauth/access_token',
        'https://graph.facebook.com/me?fields=id,name,email', 'header', 'email', NULL, NULL, 'client_secret_post',
        'authorization_code', _binary '', '2022-12-21 09:48:19'),
       ('f5db6e75-8052-11ed-b2b0-0242ac110002', NULL, 'Google', 'OpenID Connect1.0',
        ...
        'https://www.googleapis.com/oauth2/v4/token', 'https://www.googleapis.com/oauth2/v3/userinfo', 'header',
        'email', NULL, 'https://www.googleapis.com/oauth2/v3/certs', 'client_secret_basic', 'authorization_code',
        _binary '', '2022-12-20 18:42:11');
...
DROP TABLE IF EXISTS `security_identity_provider_scopes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
INSERT INTO `security_identity_provider_scopes`
VALUES ('00311ecf-80cc-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'delete:packages',
        '授予从 GitHub Packages 中删除包的权限', _binary '', _binary '\0'),
       ('0123b275-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'publish_to_groups', NULL,
        _binary '', _binary '\0'),
       ('0420654b-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'publish_video', NULL,
        _binary '', _binary '\0'),
       ('07564ac5-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'read_insights', NULL,
        _binary '', _binary '\0'),
       ('0a5b8d66-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'research_apis', NULL,
        _binary '', _binary '\0'),
       ('0b00d7ed-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'ads_management',
        'ads_management', _binary '', _binary '\0'),
       ('0dc10ce7-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_age_range', NULL,
        _binary '', _binary '\0'),
       ('0e6b85a1-80cc-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'admin:gpg_key',
        '完全管理 GPG 密钥', _binary '', _binary '\0'),
       ('0efeedb5-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'ads_read', 'ads_read',
        _binary '', _binary '\0'),
       ('112836c7-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_birthday', NULL,
        _binary '', _binary '\0'),
       ('151fd7b0-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_friends', NULL,
        _binary '', _binary '\0'),
       ('180c5435-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_gender', NULL,
        _binary '', _binary '\0'),
       ('188552a6-80cc-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '0e6b85a1-80cc-11ed-b8e3-0242ac110003', 'write:gpg_key', '创建、列出和查看 GPG 密钥的详细信息', _binary '',
        _binary '\0'),
       ('1b3ebaf0-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_hometown', NULL,
        _binary '', _binary '\0'),
       ('1d0c8039-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'attribution_read', NULL,
        _binary '', _binary '\0'),
       ('1e502669-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_likes', NULL,
        _binary '', _binary '\0'),
       ('20c623eb-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'business_management',
        NULL, _binary '', _binary '\0'),
       ('20d6122d-80cc-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '0e6b85a1-80cc-11ed-b8e3-0242ac110003', 'read:gpg_key', '列出和查看 GPG 密钥的详细信息', _binary '',
        _binary '\0'),
       ('2117a901-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_link', NULL,
        _binary '', _binary '\0'),
       ('23936971-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'catalog_management',
        NULL, _binary '', _binary '\0'),
       ('244af301-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_location', NULL,
        _binary '', _binary '\0'),
       ('274284a1-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'email', NULL,
        _binary '', _binary ''),
       ('27e92b3a-80cc-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'codespace',
        '授予创建和管理代码空间的能力', _binary '', _binary '\0'),
       ('2a131e25-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_messenger_contact',
        NULL, _binary '', _binary '\0'),
       ('2a7e15d7-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'gaming_user_locale',
        NULL, _binary '', _binary '\0'),
       ('2e084c40-80cc-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'workflow',
        '授予添加和更新 GitHub Actions 工作流程文件的能力', _binary '', _binary '\0'),
       ('2e215d2f-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_photos', NULL,
        _binary '', _binary '\0'),
       ('31469b76-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_posts', NULL,
        _binary '', _binary '\0'),
       ('346aa43a-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'user_videos', NULL,
        _binary '', _binary '\0'),
       ('34e89af9-80cf-11ed-b8e3-0242ac110003', 'f5db6e75-8052-11ed-b2b0-0242ac110002', NULL, 'openid', 'OpenID',
        _binary '', _binary ''),
       ('38d96a7a-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'whatsapp_business_management', NULL, _binary '', _binary '\0'),
       ('3b24964c-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '5338a6bc-8054-11ed-b2b0-0242ac110002', 'read:org', '对组织成员资格、组织项目和团队成员资格的只读访问权限',
        _binary '', _binary '\0'),
       ('3c849a5a-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'whatsapp_business_messaging', NULL, _binary '', _binary '\0'),
       ('43be10c4-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'instagram_graph_user_media', NULL, _binary '', _binary '\0'),
       ('4717467a-80d3-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'instagram_graph_user_profile', NULL, _binary '', _binary '\0'),
       ('48f3ec85-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'admin:public_key',
        '完全管理公钥', _binary '', _binary '\0'),
       ('490bc4ad-80cf-11ed-b8e3-0242ac110003', 'f5db6e75-8052-11ed-b2b0-0242ac110002', NULL, 'profile', 'Profile',
        _binary '', _binary ''),
       ('4e31b56a-80cf-11ed-b8e3-0242ac110003', 'f5db6e75-8052-11ed-b2b0-0242ac110002', NULL, 'email', 'Email',
        _binary '', _binary ''),
       ('5180f22b-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '48f3ec85-80cb-11ed-b8e3-0242ac110003', 'write:public_key', '创建、列出和查看公钥的详细信息', _binary '',
        _binary '\0'),
       ('5338a6bc-8054-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'admin:org',
        '全面管理组织及其团队、项目和成员资格', _binary '', _binary '\0'),
       ('59c718bd-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '48f3ec85-80cb-11ed-b8e3-0242ac110003', 'read:public_key', '列出和查看公钥的详细信息', _binary '',
        _binary '\0'),
       ('59da1a20-80cd-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'user',
        '授予用户信息读写访问权限', _binary '', _binary '\0'),
       ('5c0dfec6-8054-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '5338a6bc-8054-11ed-b2b0-0242ac110002', 'write:org', '对组织成员资格、组织项目和团队成员资格的读写权限',
        _binary '', _binary '\0'),
       ('5fd6adb1-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'groups_access_member_info', NULL, _binary '', _binary '\0'),
       ('63bdae01-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'instagram_basic', NULL,
        _binary '', _binary '\0'),
       ('67393b85-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'instagram_content_publish', NULL, _binary '', _binary '\0'),
       ('67426b2c-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'admin:org_hook',
        '授予对组织挂钩的读取、写入、ping 和删除访问权限', _binary '', _binary '\0'),
       ('68e1fc98-804e-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'projects',
        '查看、创建、更新用户的项目', _binary '', _binary '\0'),
       ('6ab6f162-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'instagram_manage_comments', NULL, _binary '', _binary '\0'),
       ('6d78a6a8-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'instagram_manage_insights', NULL, _binary '', _binary '\0'),
       ('6f358839-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'gist',
        '授予对要点的写入权限', _binary '', _binary '\0'),
       ('6f8160aa-8048-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'user_info',
        '访问用户的个人信息、最新动态等', _binary '', _binary ''),
       ('78f26ea6-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'instagram_shopping_tag_products', NULL, _binary '', _binary '\0'),
       ('7b55ca15-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'notifications',
        '授予用户通知权限', _binary '', _binary '\0'),
       ('7c7a21a9-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'leads_retrieval', NULL,
        _binary '', _binary '\0'),
       ('805f3b6c-804e-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'pull_requests',
        '查看、发布、更新用户的 Pull Request', _binary '', _binary '\0'),
       ('80f953db-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_events', NULL,
        _binary '', _binary '\0'),
       ('83420c6c-8050-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'notes',
        '查看、发布、管理用户在项目、代码片段中的评论', _binary '', _binary '\0'),
       ('83b2c85c-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_manage_ads', NULL,
        _binary '', _binary '\0'),
       ('869af382-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_manage_cta', NULL,
        _binary '', _binary '\0'),
       ('896f24e2-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'pages_manage_instant_articles', NULL, _binary '', _binary '\0'),
       ('8d27976e-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_manage_engagement',
        NULL, _binary '', _binary '\0'),
       ('8f31b469-8050-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'keys',
        '查看、部署、删除用户的公钥', _binary '', _binary '\0'),
       ('90f5a373-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_manage_metadata',
        NULL, _binary '', _binary '\0'),
       ('9130dcbb-804e-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'issues',
        '查看、发布、更新用户的 Issue', _binary '', _binary '\0'),
       ('93dd92a5-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_manage_posts',
        NULL, _binary '', _binary '\0'),
       ('96a2ad20-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_messaging', NULL,
        _binary '', _binary '\0'),
       ('97e53bed-8050-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'hook',
        '查看、部署、更新用户的 Webhook', _binary '', _binary '\0'),
       ('9978a6b0-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_read_engagement',
        NULL, _binary '', _binary '\0'),
       ('9f85686a-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'repo',
        '授予对公共和私有存储库的完全访问权限', _binary '', _binary '\0'),
       ('a06c2e19-8050-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'groups',
        '查看、管理用户的组织以及成员', _binary '', _binary '\0'),
       ('a752c8bd-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '59da1a20-80cd-11ed-b8e3-0242ac110003', 'read:user', '授予读取用户配置文件数据的权限', _binary '',
        _binary ''),
       ('a878176d-8050-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'gists',
        '查看、删除、更新用户的代码片段', _binary '', _binary '\0'),
       ('ab611416-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '9f85686a-8053-11ed-b2b0-0242ac110002', 'repo:status', '授予对公共和私有存储库中提交状态的读/写访问权限',
        _binary '', _binary '\0'),
       ('ae2c0615-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '59da1a20-80cd-11ed-b8e3-0242ac110003', 'user:email', '授予对用户电子邮件地址的读取权限', _binary '',
        _binary ''),
       ('b06e00ad-8050-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'enterprises',
        '查看、管理用户的企业以及成员', _binary '', _binary '\0'),
       ('b33b663b-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '9f85686a-8053-11ed-b2b0-0242ac110002', 'repo_deployment', '授予对公共和私有存储库的部署状态的访问权限',
        _binary '', _binary '\0'),
       ('b77e1f00-8050-11ed-b2b0-0242ac110002', '3f303dbe-8048-11ed-b2b0-0242ac110002', NULL, 'emails',
        '查看用户的个人邮箱信息', _binary '', _binary ''),
       ('b8b5fe9b-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '59da1a20-80cd-11ed-b8e3-0242ac110003', 'user:follow', '授予访问权限以关注或取消关注其他用户', _binary '',
        _binary '\0'),
       ('b92515fd-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '9f85686a-8053-11ed-b2b0-0242ac110002', 'public_repo', '限制对公共存储库的访问', _binary '', _binary '\0'),
       ('c00f9ec8-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'project',
        '授予对用户和组织项目的读/写访问权限', _binary '', _binary '\0'),
       ('c11a670c-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '9f85686a-8053-11ed-b2b0-0242ac110002', 'repo:invite', '授予接受/拒绝邀请以在存储库上进行协作的能力',
        _binary '', _binary '\0'),
       ('c9b6d052-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        'c00f9ec8-80cb-11ed-b8e3-0242ac110003', 'read:project', '授予对用户和组织项目的只读访问权限', _binary '',
        _binary '\0'),
       ('cfc64f33-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'delete_repo',
        '授予删除可管理存储库的权限', _binary '', _binary '\0'),
       ('d55b761b-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'write:discussion',
        '允许对团队讨论进行读写访问', _binary '', _binary '\0'),
       ('dd384233-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002',
        'd55b761b-80cb-11ed-b8e3-0242ac110003', 'read:discussion', '允许团队讨论的读取权限', _binary '', _binary '\0'),
       ('de54d4ee-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        '9f85686a-8053-11ed-b2b0-0242ac110002', 'security_events', '授权安全事件', _binary '', _binary '\0'),
       ('e881f438-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'write:packages',
        '授予在 GitHub Packages 中上传或发布包的权限', _binary '', _binary '\0'),
       ('e89df611-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'admin:repo_hook',
        '授予对公共或私有存储库中的存储库挂钩的读取、写入、ping 和删除访问权限', _binary '', _binary '\0'),
       ('ec391f91-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_show_list', NULL,
        _binary '', _binary '\0'),
       ('f0fad077-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_user_gender', NULL,
        _binary '', _binary '\0'),
       ('f17fb997-80cb-11ed-b8e3-0242ac110003', '8069f1af-8052-11ed-b2b0-0242ac110002', NULL, 'read:packages',
        '授予从 GitHub Packages 下载或安装包的权限', _binary '', _binary '\0'),
       ('f42d5b26-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_user_locale', NULL,
        _binary '', _binary '\0'),
       ('f50f9557-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        'e89df611-8053-11ed-b2b0-0242ac110002', 'write:repo_hook',
        '授予对公共或私有存储库中挂钩的读取、写入和 ping 访问权限', _binary '', _binary '\0'),
       ('f72c82a2-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'pages_user_timezone',
        NULL, _binary '', _binary '\0'),
       ('fa03007c-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL,
        'private_computation_access', NULL, _binary '', _binary '\0'),
       ('fd522909-80d2-11ed-b8e3-0242ac110003', '8b8e96e2-80d1-11ed-b8e3-0242ac110003', NULL, 'public_profile', NULL,
        _binary '', _binary ''),
       ('ffdac87b-8053-11ed-b2b0-0242ac110002', '8069f1af-8052-11ed-b2b0-0242ac110002',
        'e89df611-8053-11ed-b2b0-0242ac110002', 'read:repo_hook', '授予对公共或私有存储库中挂钩的读取和 ping 访问权限',
        _binary '', _binary '\0');
...
DROP TABLE IF EXISTS `security_region_identity_provider`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
(
    ...
    `application_secret`   varchar(255) NOT NULL COMMENT '应用密钥',
...
--
-- Table structure for table `security_region_secrets`
--

DROP TABLE IF EXISTS `security_region_secrets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `security_region_secrets`
(
    `id`                varchar(36) NOT NULL COMMENT '安全域密钥ID',
    `region_id`         varchar(36) NOT NULL COMMENT '安全域ID，关联security_region#id',
    `region_secret`     varchar(100)         DEFAULT NULL COMMENT '密钥',
    `secret_expires_at` datetime             DEFAULT NULL COMMENT '密钥过期时间',
    `deleted`           bit(1)      NOT NULL DEFAULT b'0' COMMENT '是否删除',
    `create_time`       datetime    NOT NULL DEFAULT current_timestamp() COMMENT '创建时间',
    `delete_time`       datetime             DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='安全域密钥';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `security_region_secrets`
--

/*!40000 ALTER TABLE `security_region_secrets` DISABLE KEYS */;
/*!40000 ALTER TABLE `security_region_secrets` ENABLE KEYS */;
...
DROP TABLE IF EXISTS `security_resource_authorize_attributes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `security_role_authorize_resources`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `security_user_authorize_applications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `security_user_authorize_attributes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2023-03-01 16:26:15
