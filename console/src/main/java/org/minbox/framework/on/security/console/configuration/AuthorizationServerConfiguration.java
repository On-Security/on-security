...
public class AuthorizationServerConfiguration extends OnSecurityOAuth2AuthorizationServerConfiguration {
     ...
     * @since 0.1.0
     */
    public static class OnSecurityConsoleServiceJwkSource implements JWKSource<SecurityContext> {
        ...
        public List<JWK> get(JWKSelector jwkSelector, SecurityContext context) throws KeySourceException {
            try {
                RSAKey rsaKey = this.loadRSAKeyFromPemFile();
        ...
        private RSAKey loadRSAKeyFromPemFile() throws Exception {
