...
INSERT INTO `security_console_menu` VALUES ('e7ceb966-a2db-11ed-8423-0242ac110002','我的应用','application_manage',NULL,_binary '',_binary '\0','2023-02-02 09:28:08',NULL,NULL);
...
`deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
`describe` varchar(50) DEFAULT NULL COMMENT '描述',
`expand` text DEFAULT NULL COMMENT '用户扩展数据',
`create_time` datetime NOT NULL DEFAULT current_timestamp() COMMENT '创建时间',
PRIMARY KEY (`id`),
...
-- Dump completed on 2023-03-29 13:25:03
